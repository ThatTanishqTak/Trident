...
namespace Engine
{
    namespace
    {
        ...
        static void BuildCube()
        {
            ...
            float verts[] = {
                // Back face
               -0.5f, -0.5f, -0.5f, 1.f, 0.f, 0.f, 1.f, 0.f, 0.f, -1.f,
                0.5f, -0.5f, -0.5f, 0.f, 1.f, 0.f, 1.f, 0.f, 0.f, -1.f,
                0.5f,  0.5f, -0.5f, 0.f, 0.f, 1.f, 1.f, 0.f, 0.f, -1.f,
               -0.5f,  0.5f, -0.5f, 1.f, 1.f, 0.f, 1.f, 0.f, 0.f, -1.f,
               // Front face
               -0.5f, -0.5f,  0.5f, 1.f, 0.f, 1.f, 1.f, 0.f, 0.f, 1.f,
                0.5f, -0.5f,  0.5f, 0.f, 1.f, 1.f, 1.f, 0.f, 0.f, 1.f,
                0.5f,  0.5f,  0.5f, 1.f, 1.f, 1.f, 1.f, 0.f, 0.f, 1.f,
               -0.5f,  0.5f,  0.5f, 0.5f, 0.5f, 0.5f, 1.f, 0.f, 0.f, 1.f,
               // Left face
               -0.5f, -0.5f,  0.5f, 1.f, 0.f, 1.f, 1.f, -1.f, 0.f, 0.f,
               -0.5f, -0.5f, -0.5f, 1.f, 0.f, 0.f, 1.f, -1.f, 0.f, 0.f,
               -0.5f,  0.5f, -0.5f, 1.f, 1.f, 0.f, 1.f, -1.f, 0.f, 0.f,
               -0.5f,  0.5f,  0.5f, 0.5f, 0.5f, 0.5f, 1.f, -1.f, 0.f, 0.f,
               // Right face
                0.5f, -0.5f, -0.5f, 0.f, 1.f, 0.f, 1.f, 1.f, 0.f, 0.f,
                0.5f, -0.5f,  0.5f, 0.f, 1.f, 1.f, 1.f, 1.f, 0.f, 0.f,
                0.5f,  0.5f,  0.5f, 1.f, 1.f, 1.f, 1.f, 1.f, 0.f, 0.f,
                0.5f,  0.5f, -0.5f, 0.f, 0.f, 1.f, 1.f, 1.f, 0.f, 0.f,
                // Bottom face
                -0.5f, -0.5f, -0.5f, 1.f, 0.f, 0.f, 1.f, 0.f, -1.f, 0.f,
                 0.5f, -0.5f, -0.5f, 0.f, 1.f, 0.f, 1.f, 0.f, -1.f, 0.f,
                 0.5f, -0.5f,  0.5f, 0.f, 1.f, 1.f, 1.f, 0.f, -1.f, 0.f,
                -0.5f, -0.5f,  0.5f, 1.f, 0.f, 1.f, 1.f, 0.f, -1.f, 0.f,
                // Top face
                -0.5f,  0.5f, -0.5f, 1.f, 1.f, 0.f, 1.f, 0.f, 1.f, 0.f,
                 0.5f,  0.5f, -0.5f, 0.f, 0.f, 1.f, 1.f, 0.f, 1.f, 0.f,
                 0.5f,  0.5f,  0.5f, 1.f, 1.f, 1.f, 1.f, 0.f, 1.f, 0.f,
                -0.5f,  0.5f,  0.5f, 0.5f, 0.5f, 0.5f, 1.f, 0.f, 1.f, 0.f
            };
