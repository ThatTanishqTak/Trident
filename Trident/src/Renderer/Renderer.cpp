...
namespace Engine
{
    ...
    void Renderer::EndScene() { s_ActiveRenderPass->End(); }

    void Renderer::DrawIndexed(const std::shared_ptr<VertexArray>& vertexArray) { RenderCommand::DrawIndexed(vertexArray); }
}